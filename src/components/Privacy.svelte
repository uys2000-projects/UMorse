<dialog id="privacy-modal" class="modal prose">
  <div class="modal-box translations-content-item en relative">
    <a href="#page" class="btn absolute top-0 right-0">X</a>
    <div class="h-full w-full">
      <h1>Privacy Policy for UMorse</h1>

      <p>
        At UMorse, accessible from https://umorse.mehmetuysal.dev, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        UMorse and how we use it.
      </p>
      ...
      <p>
        UMorse follows a standard procedure of using log files. These files log
      ...
      <p>
        ...
        advertising partners of UMorse.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on UMorse, which are sent directly
      ...
      <p>
        Note that UMorse has no access to or control over these cookies that are
      ...
      <p>
        UMorse's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        UMorse does not knowingly collect any Personal Identifiable Information
      ...
      <p>
        ...
        shared and/or collect in UMorse. This policy is not applicable to any
